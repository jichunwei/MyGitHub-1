...
"""xml2json.py  Convert XML to JSON 
   xml_dict_json.py - Convert XML to DICT to JSON, or JSON-string to XML
...
Download from: https://github.com/hay/xml2json

TAK@2012-12-13 add xml2dict() to return py-dict instead of json string. 
"""
...
def xml_2_dict(xmlfname,strip=1):
    xmlstring=open(xmlfname,'r').read()
    return xml2dict(xmlstring)
