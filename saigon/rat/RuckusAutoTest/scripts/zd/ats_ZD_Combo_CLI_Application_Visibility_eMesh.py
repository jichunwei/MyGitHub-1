...
#testcase 1
    ...
    test_case_name = '[user_app_emesh%s]'%case_name_suffix 

    user_app_rule_cfg = {'rule_description':'user_app_emesh',
    ...
    common_name = '%sGet BSSID for eMesh AP'% (test_case_name)
    test_cfgs.append(({'wlan_cfg':wlan_cfg,'ap_tag':'AP_03',
                       'ap_radio': '802.11g/n',
                      }, test_name, common_name, 2, False))
    ...
    test_cfgs.append(({'server_addr':'',
                       ...
                       'tos':'',
                       'multicast_srv':False,
                       'port':11111 }, test_name, common_name, 2, False))
    ...
    test_cfgs.append(({'application_description':'user_app_emesh'}, test_name, common_name, 2, False)) 
...
#testcase 2
    ...
    test_case_name = '[port_mapping_open_emesh%s]'%case_name_suffix  

    port_mapping_rule_cfg = {'rule_description':'port_mapping_emesh','protocol':'udp','port':'22222'}
    ...
    test_cfgs.append(({'server_addr':'',
                       ...
                       'tos':'',
                       'multicast_srv':False,
                       'port':22222 }, test_name, common_name, 2, False))
    ...
    test_name = 'CB_ZD_Verify_Application_Visibility_Info'
    common_name = '%sVerify application info in Monitor Clients page'% (test_case_name)
    test_cfgs.append(({'application_description':'port_mapping_emesh',}, test_name, common_name, 2, False)) 
...
#testcase 3
    ...
    test_case_name = '[denial_policy_emesh%s]'%case_name_suffix 
...
Default selection is 2.Input your choice:")
    ...
    if ts_cfg["testsuite_name"]:
        ...
        ts_name = "Application_Visibility - eMesh%s"%ts_suffix

    ts = testsuite.get_testsuite(ts_name, "Application_Visibility - eMesh%s"%ts_suffix , combotest=True)
