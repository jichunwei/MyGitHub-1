...
def define_wlan_cfg(hs_name,rad_user): 
    ...
    wlan_cfg = {
                'ssid': 'Application_Visibility_HS_MAC', 
                'type': 'hotspot', 
...
#testcase 1
    ...
    test_case_name = '[user_app_hs_mac%s]'%case_name_suffix 

    user_app_rule_cfg = {'rule_description':'user_app_hs_mac',
    ...
    test_cfgs.append(({'server_addr':'',
                       ...
                       'tos':'',
                       'multicast_srv':False,
                       'port':56789 }, test_name, common_name, 2, False))
    ...
    test_cfgs.append(({'application_description':'user_app_hs_mac'}, test_name, common_name, 2, False)) 
...
#testcase 2
    ...
    test_case_name = '[port_mapping_hs_mac%s]'%case_name_suffix  

    port_mapping_rule_cfg = {'rule_description':'port_mapping_hs_mac','protocol':'udp','port':'10987'}
    ...
    test_cfgs.append(({'server_addr':'',
                       ...
                       'tos':'',
                       'multicast_srv':False,
                       'port':10987}, test_name, common_name, 2, False))
    ...
    test_name = 'CB_ZD_Verify_Application_Visibility_Info'
    common_name = '%sVerify application info in Monitor Clients page'% (test_case_name)
    test_cfgs.append(({'application_description':'port_mapping_hs_mac',}, test_name, common_name, 2, False)) 
...
#testcase 3
    ...
    test_case_name = '[denial_policy_hs_mac%s]'%case_name_suffix 

    denial_policy_cfg = {'policy_description': 'denial_policy_hs_mac',
...
#clean_up                       
    ...
    test_cfgs.append(({'mac_format_type': 'all_formats',
                       'sta_tag':sta_tag}, test_name, common_name, 0, True))
...
Default selection is 2.Input your choice:")
    ...
    if ts_cfg["testsuite_name"]:
        ...
        ts_name = "Application_Visibility - Hotspot - MAC%s"%ts_suffix

    ts = testsuite.get_testsuite(ts_name, "Application_Visibility - Hotspot - MAC%s"%ts_suffix , combotest=True)
