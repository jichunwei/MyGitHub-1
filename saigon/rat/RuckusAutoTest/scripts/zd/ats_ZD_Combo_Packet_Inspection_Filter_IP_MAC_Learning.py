...
#---TestCase_3-----------------------------------------------------------------------------------
    test_case_name = 'IP_MAC learning with Proxy_ARP by ARP'
    test_combo_case_name = "[%s]" % test_case_name
    ...
    test_name = 'CB_ZD_Verify_Station_IP_MAC_Info_On_AP'
    common_name = '%sVerify the station IP and MAC info learning on AP by ARP' % (test_combo_case_name,)
    test_params = {'sta_tag': sta1_tag, 'ap_tag': ap1_tag, 'bridge': 'br0', 'expect_iptype': '4'}
    test_cfgs.append((test_params, test_name, common_name, 2, False))
...
#---TestCase_4-----------------------------------------------------------------------------------
    test_case_name = 'IP_MAC learning with Proxy_ARP by ICMP'
    test_combo_case_name = "[%s]" % test_case_name
    ...
    common_name = '%sStation sends ICMP by ping' % (test_combo_case_name,)
    ...
    test_name = 'CB_ZD_Verify_Station_IP_MAC_Info_On_AP'
    common_name = '%sVerify the station IP and MAC info learning on AP by ICMP' % (test_combo_case_name,)
    test_params = {'sta_tag': sta1_tag, 'ap_tag': ap1_tag, 'bridge': 'br0', 'expect_iptype': '4'}
    test_cfgs.append((test_params, test_name, common_name, 2, False))
...
#---TestCase_5-----------------------------------------------------------------------------------    
    ...
    test_cfgs.append(({'src_sta_tag': sta2_tag,
                       'dst_sta_tag': sta1_tag,
                       'condition': 'allowed'}, test_name, common_name, 2, False))
    ...
    test_name = 'CB_Station_Remove_All_Wlans'
    common_name = 'Remove the wlan on station1 after case: %s' % (test_case_name)
    test_cfgs.append(({'sta_tag': sta1_tag}, test_name, common_name, 0, False))
    
    test_name = 'CB_Station_Remove_All_Wlans'
    common_name = 'Remove the wlan on station2 after case: %s' % (test_case_name)
    test_cfgs.append(({'sta_tag': sta2_tag}, test_name, common_name, 0, False))
...
#---TestCase_8-----------------------------------------------------------------------------------    
    ...
    test_name = 'CB_ZD_Config_AP_Radio'
    common_name = 'Restore active AP1 radio after case: %s' % (test_case_name)
    test_params = {'cfg_type': 'config',
                   'ap_tag': ap1_tag,
                   'ap_cfg': {'radio': radio_mode, 'wlan_service': True}}
    test_cfgs.append((test_params, test_name, common_name, 0, False))
    ...
    test_name = 'CB_ZD_Config_AP_Radio'
    common_name = 'Configure active AP2 radio after case: %s' % (test_case_name)
    test_params = {'cfg_type': 'config',
                   'ap_tag': ap2_tag,
                   'ap_cfg': {'radio': radio_mode, 'wlan_service': False}}
    test_cfgs.append((test_params, test_name, common_name, 0, False))
    ...
    test_cfgs.append(({'device': 'ap'}, test_name, common_name, 0, False))
...
def create_test_suite(**kwargs):
    ...
    if ts_cfg["testsuite_name"]:
        ...
        ts_name = 'IP_MAC Learning - Packet Inspection Filter'
