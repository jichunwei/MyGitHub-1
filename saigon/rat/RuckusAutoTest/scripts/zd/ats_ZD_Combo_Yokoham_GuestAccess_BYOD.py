'''
Description:
    Test BYOD option of guest access.
...
guest_policy = {'Auth/No TOU/Redirection': {'guestaccess_policy_cfg': dict(use_guestpass_auth=True,
...
def create_test_suite(**kwargs):
    ...
    for active_ap in active_ap_list:
        ...
        ts_name = 'WLAN Type-GuestAccess-BYOD-%s-%s' % (auth_svr, target_sta_radio)
