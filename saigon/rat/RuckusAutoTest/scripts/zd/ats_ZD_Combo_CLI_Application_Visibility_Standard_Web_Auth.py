...
def define_wlan_cfg(auth_svr,rad_user): 
    ...
    wlan_cfg = {
                'ssid': 'Application_Visibility_Web', 
                'type': 'standard', 
                'auth': 'PSK', 
                'wpa_ver': 'WPA2',
                'encryption': 'AES', 
...
#testcase 1
    ...
    test_case_name = '[user_app_open_web%s]'%case_name_suffix 

    user_app_rule_cfg = {'rule_description':'user_app_open_web',
    ...
    test_cfgs.append(({'application_description':'user_app_open_web'}, test_name, common_name, 2, False)) 
...
#testcase 2
    ...
    test_case_name = '[port_mapping_open_web%s]'%case_name_suffix  

    port_mapping_rule_cfg = {'rule_description':'port_mapping_open_web','protocol':'udp','port':'32109'}
    ...
    test_cfgs.append(({'server_addr':'',
                       ...
                       'tos':'',
                       'multicast_srv':False,
                       'port':32109}, test_name, common_name, 2, False))
    ...
    test_name = 'CB_ZD_Verify_Application_Visibility_Info'
    common_name = '%sVerify application info in Monitor Clients page'% (test_case_name)
    test_cfgs.append(({'application_description':'port_mapping_open_web',}, test_name, common_name, 2, False)) 
...
#testcase 3
    ...
    test_case_name = '[denial_policy_open_web%s]'%case_name_suffix 
...
Default selection is 2.Input your choice:")
    ...
    if ts_cfg["testsuite_name"]:
        ...
        ts_name = "Application_Visibility - Standard - Web%s"%ts_suffix

    ts = testsuite.get_testsuite(ts_name, "Application_Visibility - Standard - Web%s"%ts_suffix , combotest=True)
