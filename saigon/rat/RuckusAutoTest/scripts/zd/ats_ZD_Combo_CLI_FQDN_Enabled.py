...
Verify AP joins expected ZD when enable FQDN in ZD CLI.
    ...
    Test Data:
        ...
        Primary IPV4 ADDR Secondary IPV6 FQDN Join Primary
        Primary IPV4 ADDR Secondary Empty Join Primary
        Primary IPV6 FQDN Secondary IPV6 ADDR Join Secondary
        Primary IPV4 ADDR Secondary IPV6 FQDN Join Secondary
        Primary IPV6 ADDR Secondary IPV4 FQDN Join Secondary
...
def _define_zd_discovery_test_cfg(zd1_gui_tag, zd2_gui_tag, zd1_cli_tag, zd2_cli_tag, zd1_gui_ipv6_tag, zd2_gui_ipv6_tag, tbcfg):
    ...
    #    5    IPV4    IPV6 Unreachable    Join Primary
    test_cfg_list.append({'case_name': 'Primary IPV4 ADDR Secondary IPV6 FQDN Join Primary',
                          'primary_zd_ip': zd2_ipv4_addr,
                          'secondary_zd_ip': zd_ipv6_unreachable,
                          'expected_zd_tag': zd2_gui_tag})

    #    6    IPV4         Join Primary
    test_cfg_list.append({'case_name': 'Primary IPV4 ADDR Secondary Empty Join Primary',
                          'primary_zd_ip': zd2_ipv4_addr,
                          'secondary_zd_ip': '',
                          'expected_zd_tag': zd2_gui_tag})

    #    10    FQDN IPV6 Unreachable    IPV6    Join Secondary
    ...
    #    11    IPV4 Unreachable    FQDN IPV6    Join Secondary
    test_cfg_list.append({'case_name': 'Primary IPV4 ADDR Secondary IPV6 FQDN Join Secondary',
                          'primary_zd_ip': zd_ipv4_unreachable,
                          'secondary_zd_ip': zd2_ipv6_dn,
                          'expected_zd_tag': zd2_gui_ipv6_tag})

    #    12    IPV6 Unreachable    FQDN IPV4    Join Secondary
    test_cfg_list.append({'case_name': 'Primary IPV6 ADDR Secondary IPV4 FQDN Join Secondary',
    ...
    #    5    IPV4    IPV4 Unreachable    Join Primary
    test_cfg_list.append({'case_name': 'Primary IPV4 ADDR Secondary IPV4 FQDN Join Primary',
                          'primary_zd_ip': zd2_ipv4_addr,
    ...
    #    7    IPV6    IPV6 Unreachable    Join Primary
    test_cfg_list.append({'case_name': 'Primary IPV6 ADDR Secondary IPV6 Join Primary',
                          'primary_zd_ip': zd2_ipv6_addr,
                          'secondary_zd_ip': zd_ipv6_unreachable,
                          'expected_zd_tag': zd2_gui_ipv6_tag})

    #    8    IPV6        Join Primary
    test_cfg_list.append({'case_name': 'Primary IPV6 ADDR Secondary Empty Join Primary',
                          'primary_zd_ip': zd2_ipv6_addr,
                          'secondary_zd_ip': '',
                          'expected_zd_tag': zd2_gui_ipv6_tag})
...
def create_test_suite(**kwargs):
    ...
    if active_ap:
        ...
        if ts_cfg["testsuite_name"]:
            ...
            if enable_mgmt_vlan:
                ts_name = "ZD CLI - Enable FQDN with AP Mgmt Vlan 11%s" % (target_sta_radio)
            else:
                ts_name = "ZD CLI - Enable FQDN 11%s" % (target_sta_radio)
