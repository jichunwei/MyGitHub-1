...
#---TestCase_1-----------------------------------------------------------------------------------    
    ...
    test_name = 'CB_ZD_Config_PIF_Rate_Limit'
    common_name = '%sDisable PIF rate limit after case' % (test_combo_case_name) 
    test_cfgs.append(({'expected_status': False, 'expect_config_done': True}, test_name, common_name, 2, True))
