...
#    
    ...
    common_name = 'create Radius server via WebUI for operator user'
    ...
    common_name = 'login zd web by Radius operator user'
...
def make_test_suite(**kwargs):
    attrs = dict (
        ...
        sta_id = 0,
        targetap = False,
        testsuite_name="Operator level Radius User privilege level test-Configure"
    )
    attrs.update(kwargs)
    ...
    else: ts_name ="Operator level Radius User privilege level test-Configure"
