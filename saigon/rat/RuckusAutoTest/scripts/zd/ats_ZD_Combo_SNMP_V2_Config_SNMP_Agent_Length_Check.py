'''
Set SNMP Agent settings via SNMP V2
    ...
    How to:
        1) Set snmp v2 agent setting with mid range values via SNMP v2.
...
def define_test_cfg(tcfg):
    ...
    test_name = 'CB_ZD_CLI_Set_SNMP_Agent'
    common_name = '%sSet SNMP Agent V2 via ZD CLI with Default Setting'
    test_cfgs.append(({'snmp_agent_cfg': tcfg['enable_snmp_agent_v2_cfg']}, test_name, common_name, 1, False))
    ...
    test_name = 'CB_ZD_CLI_Set_SNMP_Agent'
    common_name = 'Set SNMP Agent V2 via ZD CLI with Default Setting'
    ...
    test_name = 'CB_ZD_CLI_Set_SNMP_Agent'
    common_name = '%sSet SNMP Agent V3 via ZD CLI with Default Setting'
    test_cfgs.append(({'snmp_agent_cfg': tcfg['enable_snmp_agent_v3_cfg']}, test_name, common_name, 1, False))
    ...
    test_name = 'CB_ZD_CLI_Set_SNMP_Agent'
    common_name = '%sEnable SNMP Agent V2 via CLI with Default Setting' % (test_case_name,)
    test_cfgs.append(({'snmp_agent_cfg': tcfg['enable_snmp_agent_v2_cfg']}, test_name, common_name, 1, False))
...
def create_test_suite(**kwargs):    
    ...
    ts_name = 'ZD SNMP V2 - SNMP Agent Configuration - Length Checking'
