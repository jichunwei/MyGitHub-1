...
def getTestbed(**kwargs):
    atrs = {'zd_ip_addr':'192.168.0.2', 'svr_ip_addr':'192.168.0.252', 'tbtype':'ZD_ATA_Stations',
            'zd_username':'admin', 'zd_password':'admin', 'shell_key': '',
            'ata_IP':AtaWrapper.ata_IP,
            'veriwave_IP':AtaWrapper.veriwave_IP,
            'wifi_01':AtaWrapper.wifi_01,
            'wifi_blade_01':AtaWrapper.wifi_blade_01,
            'wifi_port_01':AtaWrapper.wifi_port_01,
            'enet_01':AtaWrapper.enet_01,
            'enet_blade_01':AtaWrapper.enet_blade_01,
            'enet_port_01':AtaWrapper.enet_port_01,
            'fiveg_channel': AtaWrapper.fiveg_channel,
            'twog_channel': AtaWrapper.twog_channel            
            }
    atrs.update(kwargs)
    ...
    try:
        ...
        ata_conf = _getAtrVal('ata_conf', atrs,
                 {'ata_IP':AtaWrapper.ata_IP,
                  'veriwave_IP':AtaWrapper.veriwave_IP,
                  'wifi_01':AtaWrapper.wifi_01,
                  'wifi_blade_01':AtaWrapper.wifi_blade_01,
