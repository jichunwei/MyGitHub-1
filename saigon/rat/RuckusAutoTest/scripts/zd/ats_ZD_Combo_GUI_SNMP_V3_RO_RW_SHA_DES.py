'''
Configure SNMP V3 agent via ZD GUI [RO RW Auth=SHA Priv=DES]
...
def define_test_cfg(tcfg):
    ...
    test_case_name = '[RO RW Auth=SHA Priv=DES]'
...
def create_test_suite(**kwargs):
    ...
    ts_name = 'ZD GUI - SNMP V3 Validation - Both RO and RW (SHA,DES)'
    ts = testsuite.get_testsuite(ts_name, 'Verify SNMP V3 RO and RW Authentication is SHA and Privacy is DES', combotest=True)
