...
def define_test_configuration(tcfg):
    ...
    common_name = '%ssuper user can not remove dpsk'%test_case_name
    ...
    common_name = '%ssuper user can not set debug log level'%test_case_name
    test_cfgs.append(({'level':'super'}, test_name, common_name, 1,False))
...
def make_test_suite(**kwargs):
    attrs = dict (
        ...
        sta_id = 0,
        targetap = False,
        testsuite_name="super level Tacacs Plus User privilege level test-Monitor and Admin"
    )
    attrs.update(kwargs)
    ...
    else: ts_name ="super level Tacacs Plus User privilege level test-Monitor and Admin"
...
#    check_validation(test_cfgs)
    ts = testsuite.get_testsuite(ts_name, "super level Tacacs Plus User privilege level test-Monitor and Admin", interactive_mode = attrs["interactive_mode"], combotest=True)
