...
def define_test_cfg(cfg,enable_tunnel):
    ...
    wlan_cfg = define_wlan_cfg(rad_user)
    ...
    guest_name = 'App_Visibility_Guest'
...
#testcase 1
    ...
    test_case_name = '[user_app_guest_access%s]'%case_name_suffix 

    user_app_rule_cfg = {'rule_description':'user_app_guest_access',
    ...
    test_cfgs.append(({'application_description':'user_app_guest_access'}, test_name, common_name, 2, False)) 
...
#testcase 2
    ...
    test_case_name = '[port_mapping_guest_access%s]'%case_name_suffix  

    port_mapping_rule_cfg = {'rule_description':'port_mapping_guest_access','protocol':'udp','port':'21098'}
    ...
    test_name = 'CB_ZD_Verify_Application_Visibility_Info'
    common_name = '%sVerify application info in Monitor Clients page'% (test_case_name)
    test_cfgs.append(({'application_description':'port_mapping_guest_access',}, test_name, common_name, 2, False)) 
...
#testcase 3
    ...
    test_case_name = '[denial_policy_guest_access%s]'%case_name_suffix 

    denial_policy_cfg = {'policy_description': 'denial_policy_guest_access',
    ...
    #test_cfgs.append(({'sta_tag': sta_tag, 'dest_ip': target_ip_addr,}, test_name, common_name, 2, False))
    ...
    test_cfgs.append(({'sta_tag': sta_tag, 'server_ip': target_ip_addr,'dest_port':80}, test_name, common_name, 2, False))  
    ...
    test_cfgs.append(({'sta_tag': sta_tag, 'server_ip': target_ip_addr,'dest_port':80,'negative':True}, test_name, common_name, 2, False))    
...
Default selection is 2.Input your choice:")
    ...
    if ts_cfg["testsuite_name"]:
        ...
        ts_name = "Application_Visibility - GuestAccess%s"%ts_suffix

    ts = testsuite.get_testsuite(ts_name, "Application_Visibility - GuestAccess%s"%ts_suffix , combotest=True)
