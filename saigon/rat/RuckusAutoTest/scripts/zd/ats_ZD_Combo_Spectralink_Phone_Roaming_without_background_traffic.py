...
def define_test_cfg(**kwargs):#active_ap, wgs_type, enable_tunnel, enable_vlan, vlan_id='55'):
    fcfg = dict( data_vlan_id = '66',
                 ...
                 skl_file='airpcap_ch_setting.skl')
    fcfg.update(kwargs)
...
def define_test_cfg_by_phone_list(**kwargs):
    ...
    for phone in fcfg['phone_list']:
        ...
        phone_test_cfg.extend(
          ...
          ( dict(infname=fcfg['infname'], duration=fcfg['duration'],ap_tag=fcfg['ap_tag_1'],sta_tag=fcfg['sta_tag_1'],phone_mac=get_ph_mac(phone),dut_phone=phone,skl_file=fcfg['skl_file']),
