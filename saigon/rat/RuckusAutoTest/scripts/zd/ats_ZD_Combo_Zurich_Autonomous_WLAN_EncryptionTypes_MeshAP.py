...
def define_test_cfg(cfg, wlan_cfg_param_list):
    ...
    #@auth:yuyanan 2014-7-18 optimize
    ...
    test_cfgs.append(({'mesh_ap_list':[mesh_ap_tag],'for_upgrade_test':False}, test_name, common_name, 0, False))
    ...
    common_name = 'Create active AP is %s '%(mesh_ap_tag)
    test_cfgs.append(({'active_ap':mesh_ap_tag,
    ...
    for i in wlan_cfg_param_list:
        wlan_cfg = _define_wlan_cfg(i[0], i[1], i[2], i[3], i[4],i[5], i[6],i[7],cfg['vlan_id'])
...
def createTestSuite(**kwargs):
    ...
    active_ap_list = ap_sym_dict.keys()
...
#           ('PSK', 'WPA_Mixed', 'TKIP', '', key_string_wpa_mixed, 'PSK', 'WPA2', 'TKIP'),  #11
    ...
    if ts_cfg["testsuite_name"]:
        ...
        ts_name = "Autonomous WLAN EncryptionTypes - MeshAP - %s" % target_sta_radio
