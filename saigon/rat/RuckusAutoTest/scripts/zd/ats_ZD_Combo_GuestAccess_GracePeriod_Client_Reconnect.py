...
def define_test_cfgs(tcfg):
    ...
    guest_pass_cfg['guest_fullname'] = 'guest-del'
    grace_period = 2
    ...
    guest_pass_cfg = deepcopy(tcfg['guest_pass_cfg'])
    guest_pass_cfg['wlan'] = wlan_cfg['ssid']
    guest_pass_cfg['guest_fullname'] = 'guest-diff'
    grace_period = 3
    ...
    guest_pass_cfg = deepcopy(tcfg['guest_pass_cfg'])
    guest_pass_cfg['wlan'] = wlan_cfg['ssid']
    guest_pass_cfg['guest_fullname'] = 'guest-roam'
    grace_period = 3
...
def create_test_suite(**kwargs):
    ...
    if attrs['ts_name']:
        ...
        ts_name = "Guest Access - Grace Period - Client Reconnect - %s - %s" \
