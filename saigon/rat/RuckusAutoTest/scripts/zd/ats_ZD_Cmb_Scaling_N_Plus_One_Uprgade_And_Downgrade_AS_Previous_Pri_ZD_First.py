...
#    
    ...
    test_cfgs.append(({'build':'base_zd1'},test_name, common_name, 1, False))
    
    test_name = 'CB_ZD_Download_File_From_Zd'
    common_name = '%sDownload xml files in pri zd before upgrade'%test_case_name
    test_cfgs.append(({'prefix':'base_zd1'},test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_CLI_Get_Xml_File_List_In_ZD'
    common_name = '%sget xml file list in sec ZD'%test_case_name
    test_cfgs.append(({'build':'base_zd2'},test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_Download_File_From_Zd'
    common_name = '%sDownload xml files in sec zd before upgrade'%test_case_name
    test_cfgs.append(({'prefix':'base_zd2'},test_name, common_name, 2, False))
    ...
    test_cfgs.append(({'zd':'zd1','zdcli':'zdcli1','build':'target'},test_name, common_name, 2, False))
    ...
    test_cfgs.append(({'zd':'zd2','zdcli':'zdcli2','build':'target'},test_name, common_name, 1, False))
    ...
    test_cfgs.append(({'build':'target_zd1'},test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_Download_File_From_Zd'
    common_name = '%sDownload xml files in pri zd after upgrade'%test_case_name
    test_cfgs.append(({'prefix':'target_zd1'},test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_CLI_Get_Xml_File_List_In_ZD'
    common_name = '%sget xml file list in sec ZD after upgrade'%test_case_name
    test_cfgs.append(({'build':'target_zd2'},test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_Download_File_From_Zd'
    common_name = '%sDownload xml files in sec zd after upgrade'%test_case_name
    test_cfgs.append(({'prefix':'target_zd2'},test_name, common_name, 2, False))
    ...
    test_cfgs.append(({'scenario':'upgrade','prefix1':'base_zd1','prefix2':'target_zd1','pc_dir':pc_dir},test_name, common_name, 2, False))

    test_name = 'CB_ZD_Compare_Xml_Files_On_Pc'
    common_name = '%scompare the sec zd configuration by comparing xml files before and after upgrade'%test_case_name
    test_cfgs.append(({'scenario':'upgrade','prefix1':'base_zd2','prefix2':'target_zd2','not_cmp_file':['ap-list.xml','apgroup-list.xml'],'pc_dir':pc_dir},test_name, common_name, 2, True))
    ...
    test_cfgs.append(({'build':'base2_zd1'},test_name, common_name, 1, False))
    
    test_name = 'CB_ZD_Download_File_From_Zd'
    common_name = '%sDownload xml files in pri zd after upgrade and downgrade'%test_case_name
    test_cfgs.append(({'prefix':'base2_zd1'},test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_CLI_Get_Xml_File_List_In_ZD'
    common_name = '%sget xml file list in sec ZD after upgrade and downgrade'%test_case_name
    test_cfgs.append(({'build':'base2_zd2'},test_name, common_name, 1, False))
    
    test_name = 'CB_ZD_Download_File_From_Zd'
    common_name = '%sDownload xml files in sec zd after upgrade and downgrade'%test_case_name
    test_cfgs.append(({'prefix':'base2_zd2'},test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_Compare_Xml_Files_On_Pc'
    common_name = '%scompare the pri zd configuration by comparing xml files before and after upgrade'%test_case_name
    test_cfgs.append(({'scenario':'upgrade','prefix1':'base_zd1','prefix2':'base2_zd1','pc_dir':pc_dir},test_name, common_name, 2, True))

    test_name = 'CB_ZD_Compare_Xml_Files_On_Pc'
    common_name = '%scompare the sec zd configuration by comparing xml files before and after upgrade'%test_case_name
    test_cfgs.append(({'scenario':'upgrade','prefix1':'base_zd2','prefix2':'base2_zd2','not_cmp_file':['ap-list.xml','apgroup-list.xml'],'pc_dir':pc_dir},test_name, common_name, 2, True))
...
def make_test_suite(**kwargs):
    attrs = dict (
        ...
        sta_id = 0,
        targetap = False,
        testsuite_name="upgrade and downgrade as previous with N plue one configuration,pri first"
    )
    attrs.update(kwargs)
...
#        active_radio = testsuite.get_target_sta_radio()
    ...
    else: ts_name ="upgrade and downgrade as previous with N plue one configuration,pri first"
    wlan_cfg = {
...
#                active_radio = active_radio,
    ...
    ts = testsuite.get_testsuite(ts_name, "upgrade and downgrade as previous with N plue one configuration,pri first", interactive_mode = attrs["interactive_mode"], combotest=True)
