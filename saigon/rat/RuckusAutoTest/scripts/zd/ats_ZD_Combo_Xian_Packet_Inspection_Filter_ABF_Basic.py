...
#---TestCase_2---------------------------------------------------------------------------------------
    ...
    test_name = 'CB_ZD_Verify_ABF_On_AP'
    common_name = '%sVerify wlans ABF status on AP' % (test_combo_case_name,)
    test_params = {'ap_tag': 'ap1', 'bridge':'br0', 'expected_status': True, 'waiting_time': 10}
    test_cfgs.append((test_params, test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_Config_ABF'
    common_name = '%sDisable ABF' % (test_combo_case_name,)
    test_cfgs.append(({'do_abf': False}, test_name, common_name, 2, False))
    
    test_name = 'CB_ZD_Verify_ABF_On_AP'
    common_name = '%sVerify wlans ABF status on AP again' % (test_combo_case_name,)
