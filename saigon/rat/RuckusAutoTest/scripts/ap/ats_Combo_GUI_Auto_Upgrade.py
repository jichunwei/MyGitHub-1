...
def define_upgrade_cfg():
    ap_up_cfg = {'sta_ip_list': ['192.168.1.11'],
                 ...
                 'up_cfg': {'zf7363': {'target_build_stream': 'ZF7211_mainline',
                                       'target_bno': '85',
                                       'baseline_build_stream': 'ZF7211_mainline',
                                       'baseline_bno':'61',
                                       },
                            },
                 }
...
def define_ap_model_ip_mapping():
    ap_cfg = {'zf7363': ['192.168.0.166','192.168.0.169']}
...
def create_test_suite(**kwargs):
    ...
    for model_up_cfg in model_up_cfg_list:
        ...
        ts_name = 'AP GUI - Auto upgrade %s Baseline %s Target %s' % (model_name, baseline_build, target_build)
        ts = testsuite.get_testsuite(ts_name, 'Verify AP auto upgrade via CLI', combotest=True)
