...
class CB_Station_CaptivePortal_Perform_WebAuth(Test):
    '''
    classdocs
    '''
    ...
    def _perform_web_auth(self):
        '''
        '''
        logging.info("Perform Web Auth on the station %s" % self.sta_tag)
        ...
        try:
            ...
            messages = self.sta.perform_web_auth_using_browser(self.browser_id, arg)
            ...
            self.passmsg += "Perform Web Auth successfully on station [%s]." % self.sta_tag
