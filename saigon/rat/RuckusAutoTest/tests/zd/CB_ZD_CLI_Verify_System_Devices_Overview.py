...
class CB_ZD_CLI_Verify_System_Devices_Overview(Test):
    '''
    ...
    def test(self):            
        pass_msg_list = []    
        r, c = lib.verify_devices_overview(self.gui_sys_devices_info, self.cli_sys_info['Devices Overview'])        
        if r:            
            pass_msg_list.append('System devices overview checking is correct')
        else:
    ...
    def _retrive_carrier_bag(self):
        self.gui_sys_devices_info = self.carrierbag['existed_sys_devcies_info']
