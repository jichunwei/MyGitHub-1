...
class CB_ZD_Privilage_Level_Del_Role(Test):
    ...
    def _initTestParameters(self, conf):
        ...
        self.role_name = self.conf['role_name']
        self.errmsg = ''
        self.passmsg = ''
        
    def _user_behavior_verify(self):
        return zd_admin_privilage_level.delete_role(self.zd,self.level,self.role_name)
