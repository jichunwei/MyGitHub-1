...
class CB_ZD_Privilage_Level_Edit_Wlan(Test):
    ...
    def _initTestParameters(self, conf):
        ...
        self.errmsg = ''
        self.passmsg = ''
        self.wlanconf ={'ssid':'privilage_test_edit_wlan',
                      'type': 'guest', 
                      'auth': 'open',
                      'encryption' : 'none',                
                      }
    ...
    def _user_behavior_verify(self):
        return zd_admin_privilage_level.edit_wlan(self.zd,self.level,self.ssid,self.wlanconf)
