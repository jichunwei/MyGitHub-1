...
class CB_ZD_CLI_Add_Vlan_Pools(Test):
    ...
    def test(self):
        ...
        if self.conf['specified_num']:
            res, value = vp.cfg_specified_num_of_vlan_pools(self.zdcli, self.conf['specified_num'])
        else:
            res, value = vp.cfg_vlan_pools(self.zdcli, self.vlan_pool_cfg_list)
        time.sleep(2)
    ...
    def _init_test_params(self, conf):
        ...
        self.vlan_pool_cfg_list = self.conf['vlan_pool_cfg_list']
