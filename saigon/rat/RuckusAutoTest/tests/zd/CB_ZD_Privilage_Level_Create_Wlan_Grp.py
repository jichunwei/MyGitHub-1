...
class CB_ZD_Privilage_Level_Create_Wlan_Grp(Test):
    ...
    def _initTestParameters(self, conf):
        ...
        self.wg_name = self.conf['wlan_grp_name']
        self.errmsg = ''
        self.passmsg = ''
        
    def _user_behavior_verify(self):
        return zd_admin_privilage_level.add_wlan_grp(self.zd,self.level,self.wg_name)
