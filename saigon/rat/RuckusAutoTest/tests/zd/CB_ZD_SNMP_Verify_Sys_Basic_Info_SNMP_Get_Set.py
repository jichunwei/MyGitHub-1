...
class CB_ZD_SNMP_Verify_Sys_Basic_Info_SNMP_Get_Set(Test):
    ...
    def _verify_sys_info_get_set(self):
        ...
        try:            
            res_d = sys_info.verify_sys_info_snmp_test_data(self.snmp_sys_info_dict, self.test_cfg_sys_info)
            
            self.errmsg = res_d   
            self.passmsg = 'System basic information are same between SNMP get and SNMP set.'             
