...
class CB_ZD_Privilage_Level_Remove_DPSK(Test):
    def config(self, conf):
        self._initTestParameters(conf)

    def test(self):
        res = self._delete_all_dpsk()
    ...
    def _delete_all_dpsk(self):
        return zd_admin_privilage_level.delete_all_dpsk(self.zd,self.level)
