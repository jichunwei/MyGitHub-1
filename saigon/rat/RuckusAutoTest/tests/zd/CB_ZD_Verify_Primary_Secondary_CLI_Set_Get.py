...
class CB_ZD_Verify_Primary_Secondary_CLI_Set_Get(Test):
    required_components = []
    ...
    def test(self):
        try:
            ...
            self.errmsg = lib.verify_limited_zd_discovery(self.set_zd_discovery_cfg, self.cli_get_zd_discoverty_cfg)            
        except Exception, e:
