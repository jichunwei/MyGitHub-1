...
tea.py chk_radius_server te_root=u.zdcliu.zdcli.aaaservers
'''
...
def do_test(zdcli, res_d):
    ...
    r, c = svr_lib.verify_aaa_server_by_type(zdcli, radius_server, svr_d, svr_lib.RADIUS)
    if r:
        return ("PASS", "")
    else:
        return ("FAIL", c)
