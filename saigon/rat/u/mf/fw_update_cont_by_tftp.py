...
Pre-requirement:
    tftp server:
        [1] for 3CDaemon tftp server, it can only support up to 3 ftp sessions at one time.
        [2] default ftp host is 192.168.30.10, overwritten by arg host
        [3] tftp home directory should contain ap control files and their images
...
Usage:
    ...
    tea.py u.fm.fw_update_cont_by_tftp ip_addr=192.168.30.245
    tea.py u.fm.fw_update_cont_by_tftp ip_addr=192.168.30.245 username=superx password=sx-admin
    tea.py u.fm.fw_update_cont_by_tftp ip_addr=192.168.30.245 host=192.168.30.32
    tea.py u.fm.fw_update_cont_by_tftp control_1=mf7211_image1_cntrl.rcks control_2=mf7211_image1_cntrl.rcks

    # If arg ctrl_list presented, it overwries control_1 and control_2
    tea.py u.fm.fw_update_cont_by_tftp ctrl_list=['image1_cntrl.rcks','image2_cntrl.rcks','image3_cntrl.rcks']
