...
import WGconfig_cfgLib_ref4 as BCLIB
...
acl_conf = {'acl_name':'TestForFunL2ACL', 'description':'L2AccessControl', 'allowed_access': True, 'mac_list':['00:00:00:00:11:00', '00:22:43:13:39:30']}
...
def do_cfg(**kwargs):
    ...
    BCLIB.create_l3_acl_policy(zd, L3acl_conf, num_of_acl = 11)
